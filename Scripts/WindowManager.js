...
function saveWindowState(){
    if(canSave) try {
        if(localStorage){
            const windowState = {};
            for (let id in windows) windowState.push(transferEssentialWindowData(windows[id], {}));
...
function transferEssentialWindowData(source, target){
    ...
    if(canSave) try {
        if(localStorage && localStorage.windowState){
            ...
            for (let window in parsedWindows) {
                ...
                transferEssentialWindowData(parsedWindows[window], windows[window])
...
//     this.remove = function(){ activeDrag = false },
//     this.resizeFunctions = [
//         function(dialog, offset, difference, style){ style.left = (dialog.x = offset.left + difference.x) + "px", style.top = (dialog.y = offset.top + difference.y) + "px" },
//         function(dialog, offset, difference, style){ style.height = (dialog.height = offset.height - difference.y) + "px", style.top = (dialog.y = offset.top + difference.y) + "px" },
...
//         function(dialog, offset, difference, style){ style.left = (dialog.x = offset.left + difference.x) + "px", style.width = (dialog.width = offset.width - difference.x) + "px" },
//         function(dialog, offset, difference, style){ style.left = (dialog.x = offset.left + difference.x) + "px", style.width = (dialog.width = offset.width - difference.x) + "px", style.height = (dialog.height = offset.height - difference.y) + "px", style.top = (dialog.y = offset.top + difference.y) + "px" },
//         function(dialog, offset, difference, style){ style.width = (dialog.width = offset.width + difference.x) + "px", style.height = (dialog.height = offset.height - difference.y) + "px",style.top = (dialog.y = offset.top + difference.y) + "px" },
...
//         function(dialog, offset, difference, style){ style.left = (dialog.x = offset.left + difference.x) + "px", style.width = (dialog.width = offset.width - difference.x) + "px", style.height = (dialog.height = offset.height + difference.y) + "px" }
//     ];
// }
